...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request)
    {
        $request->validate([
            ...
            'subcategory_name_en.required' => 'Please Input Sub Category Name English',
            'subcategory_name_hin.required' => 'Please Input Sub Category Name Hindi',
        ]);
...
//                                  ==================
    ...
    public function SubSubCategoryStore(Request $request) {
        $request->validate([
            ...
            'subsubcategory_name_en.required' => 'Please Input Sub-Sub Category Name English',
            'subsubcategory_name_hin.required' => 'Please Input Sub-Sub Category Name Hindi',
        ]);
