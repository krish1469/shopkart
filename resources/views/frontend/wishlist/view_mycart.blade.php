      ...
      <table class="table">
       <thead>
        <tr>
         ...
         <th class="cart-description item col-md-3">Product Name</th>
         <th class="cart-product-name item col-md-2">Product Colour</th>
         <th class="cart-edit item col-md-2">Product Size</th>
