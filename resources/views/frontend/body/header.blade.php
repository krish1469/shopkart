        ...
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            <li><a href="{{ route('mycart') }}"><i class="icon fa fa-shopping-cart"></i>
              @if (session()->get('language') == 'hindi')मेरा कार्ट @else My Cart @endif</a></li>
            <li><a href="{{ route('checkout') }}"><i class="icon fa fa-check"></i>
              @if (session()->get('language') == 'hindi')चेक आउट @else Checkout @endif</a></li>
            <li><a href="" type="button" data-toggle="modal" data-target="#orderTracking"><i class="icon fa fa-map-marker"></i>
              @if (session()->get('language') == 'hindi')ऑर्डर ट्रैक @else Track Order @endif</a></li>
            <li>
              @auth
                  <a href="{{ route('dashboard') }}"><i class="icon fa fa-user"></i>
                    @if (session()->get('language') == 'hindi')प्रोफ़ाइल @else Profile @endif</a>
              @else 
                  <a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>
                    @if (session()->get('language') == 'hindi')लॉग इन/रजिस्टर @else Login/Register @endif</a>
              @endauth
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                          ...
                          <div class="row">
                              ...
                              @foreach ($subcategories as $subcategory)
                                <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                  ...
                                  <h2 class="title">
                                      @if (session()->get('language') == 'hindi'){{ $subcategory->subcategory_name_hin }} @else {{ $subcategory->subcategory_name_en }} @endif</h2>
                                    {{-- </a> --}}
                                    ...
                                    @endforeach  <!-- End Sub-Sub Category for each -->
                                </div>
                              @endforeach  <!-- End Sub Category for each -->
                            <!-- /.col -->
                ...
                @endforeach  <!-- End Category for each -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><b>Track your Order</b></h4>
      ...
      <div class="modal-body">
        ...
        <form action="{{ route('order.tracking') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <input type="text" name="code" class="form-control" required="" placeholder="Please enter your Invoice Number">
          </div>

          <button type="submit" class="btn btn-primary" style="margin-left: 17px;">Track Order</button>
...
{{-- End of Advanced Search Styles CSS --}}


{{-- Advanced Search Show and Hide Script --}}
<script>
...
{{-- End of Advanced Search Show and Hide Script --}}
