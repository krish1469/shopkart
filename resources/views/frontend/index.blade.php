                  ...
                  <div class="caption bg-color vertical-center text-left">
                    {{-- <div class="slider-header fadeInDown-1">Top Brands</div> --}}
                      <div class="big-text fadeInDown-1">
                          @if (session()->get('language') == 'hindi'){{ $slider->title_hin }} @else {{ $slider->title_en }} @endif
                      </div>
                      <div class="excerpt fadeInDown-2 hidden-xs"> <span>
                        @if (session()->get('language') == 'hindi'){{ $slider->description_hin }} @else {{ $slider->description_en }} @endif</span> </div>
                      <div class="button-holder fadeInDown-3"> <a href="index.php?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">
                        @if (session()->get('language') == 'hindi') अभी खरीदो @else Shop Now @endif</a> 
                      </div>
                  </div>
                  <!-- /.caption --> 
                </div>
                  ...
                  <div class="item">
                    <div class="blog-post">
                      ...
                      <div class="blog-post-info text-left">
                        ...
                        <a href="{{ route('post.details', $blog->id) }}" class="lnk btn btn-primary">@if (session()->get('language') == 'hindi') अधिक पढ़ें @else READ MORE @endif</a> </div>
                      <!-- /.blog-post-info --> 
