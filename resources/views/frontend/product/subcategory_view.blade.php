  ...
  <div class='container'>
    <div class='row'>
      ...
      <div class='col-md-9'> 
        ...
        @foreach ($breadsubcat as $item)
            <span><b>{{ $item->category->category_name_en }}</b></span>
        @endforeach
        <b>/</b>
        @foreach ($breadsubcat as $item)
            <span class="badge" style="background: #339cbe">{{ $item->subcategory_name_en }}</span>
        @endforeach
      ...
      <div class="ajax-loadmore-product text-center" style="display: none;">
        <img src="{{ asset('frontend/assets/images/loadingicon.svg') }}" style="width: 80px; height: 80px;" alt="">
      </div>
