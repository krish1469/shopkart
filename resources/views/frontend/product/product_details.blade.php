...
@endphp
         ...
         @if (session()->get('language') == 'hindi'){{ $product->short_descp_hin }} @else {{ $product->short_descp_en }} @endif
            ...
            @endif
							...
							{{--====================== Add Product Colour And Product Size ========================--}}
							<div class="row">
									<div class="col-sm-6">
											<div class="form-group">
												...
												@else
													<label class="info-title control-label">Choose Colour</label>
								...
								{{--====================== End Add Product Colour And Product Size ========================--}}
							...
							<!-- Share Option -->
							<div class="addthis_inline_share_toolbox_2n7a"></div>							
									...
									<div class="product-tab">
																...
																@foreach ($reviews as $item)
																	...
																	@else
																					<div class="review">
																							...
																							<div class="row">
																										<div class="col-md-6">
																														<img src="{{ (!empty($item->user->profile_photo_path)) ? url('upload/user_images/'.$item->user->profile_photo_path):url('upload/no_image.jpg')}}" alt="" style="border-radius: 50%;" height="40px" width="40px">&nbsp;&nbsp;<b>{{ $item->user->name }}</b>
																							...
																							<div class="review-title"><span class="summary"><b>{{ $item->summary }}</b></span><span class="date"><i class="fa fa-calendar"></i><span>{{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span></span></div>
										...
										<div class="product-add-review">
											...
											<div class="review-form">
												@guest
																<p><b>Please <a href="{{ route('login') }}">Login</a> to your Account For Submitting Review</b></p>
												@else
																			...
																			<div class="row">
																				<div class="col-sm-6">
																					...
																					<div class="form-group">
																						...
																						<input type="text" class="form-control txt" name="summary" placeholder="Write summary">
																					</div><!-- /.form-group -->
																				</div>
																				...
																				<div class="col-md-6">
																					<div class="form-group">
																						...
																						<textarea class="form-control txt txt-review" name="comment" rows="4" placeholder="Enter Comment"></textarea>
																					</div><!-- /.form-group -->
																				</div>
																			</div><!-- /.row -->
...
<!-- Share option Script -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-612f3a646f45a600"></script>
