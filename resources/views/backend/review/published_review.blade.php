			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Published Reviews<span class="badge badge-pill badge-danger">{{ count($review)  }}</span></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
       ...
       @foreach ($review as $item)
        <tr>
            ...
            @elseif($item->status == 1)
                <span class="badge badge-pill badge-success" style="background: #15833a">Published</span>
            @endif
        </td>
								<td>
         <a href="{{ route('review.delete', $item->id) }}" class="btn btn-danger btn-sm" id="delete"><i class="fa fa-trash"></i> </a>
