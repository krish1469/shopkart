			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Products List <span class="badge badge-pill badge-danger">{{ count($products)  }}</span></h3>
						<span><a href="{{ route('add.product') }}" class="btn btn-info" style="float: right;">Add Product</a></span>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
       ...
       @foreach ($products as $item)
        ...
        <td>Rs &nbsp;{{ $item->selling_price }}</td>
            ...
            @endif
								...
								<td width="25%">
         <a href="{{ route('product.details',$item->id) }}" class="btn btn-primary" title="Product Details"><i class="fa fa-eye"></i></a>
