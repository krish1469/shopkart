...
<head>
  <meta charset="utf-8">
    ...
    <title>Shopkart Admin - Log in </title>
         ...
         @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" name="password" id="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
