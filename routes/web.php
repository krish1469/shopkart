...
Route::prefix('product')->group(function () {
    ...
    Route::post('/image/update', [ProductController::class, 'MultiImageUpdate'])->name('update.product.images');
...
Route::prefix('orders')->group(function () {
    ...
    // Route::get('/edit/{id}', [OrderController::class, 'CouponEdit'])->name('coupon.edit');
    // Route::post('/update/{id}', [OrderController::class, 'CouponUpdate'])->name('coupon.update');
    // Route::get('/delete/{id}', [OrderController::class, 'CouponDelete'])->name('coupon.delete');
});
...
Route::prefix('blog')->group(function () {
    ...
    // Admin View Blog Routes
    Route::get('/manage/post', [BlogController::class, 'ManageBlogPost'])->name('manage.post');
    Route::get('/add/post', [BlogController::class, 'AddBlogPost'])->name('add.post');
    Route::post('/post/store', [BlogController::class, 'BlogPostStore'])->name('post.store');
    Route::get('/post/edit/{id}', [BlogController::class, 'BlogPostEdit'])->name('blog.post.edit');
    Route::post('/post/data/update', [BlogController::class, 'BlogPostDataUpdate'])->name('post.data.update');
    Route::post('/post/thumbnail/update', [BlogController::class, 'PostThumbnailImageUpdate'])->name('update.post.thumbnail');
...
Route::prefix('return')->group(function () {
    ...
    Route::get('/request/admin', [ReturnController::class, 'ReturnRequest'])->name('return.request');
    Route::get('/approve/admin/{order_id}', [ReturnController::class, 'ReturnRequestApprove'])->name('return.approve');
    Route::get('/all/request/admin', [ReturnController::class, 'ReturnAllRequest'])->name('all.request');
});
...
Route::prefix('review')->group(function () {
    ...
    Route::get('/approve/admin/{id}', [ReviewController::class, 'ReviewApprove'])->name('review.approve');
...
Route::prefix('adminuserrole')->group(function () {
    // Admin Manage Admin User Roles Routes
    Route::get('/all', [AdminUserController::class, 'AllAdminUserRole'])->name('all.admin.users');
    Route::get('/add', [AdminUserController::class, 'AddAdminUserRole'])->name('add.adminusers');
    Route::post('/store', [AdminUserController::class, 'StoreAdminUserRole'])->name('admin.user.store');
    Route::get('/edit/{id}', [AdminUserController::class, 'EditAdminUserRole'])->name('edit.admin.user');
    Route::post('/update', [AdminUserController::class, 'UpdateAdminUserRole'])->name('admin.user.update');
    Route::get('/delete/{id}', [AdminUserController::class, 'DeleteAdminUserRole'])->name('delete.admin.user');
});
...
// Frontend SubCategory and Sub-SubCategory Wise Page Route
...
// Remove Data From Mini Cart with Ajax
...
Route::group(['prefix' => 'user', 'middleware' => ['user', 'auth'], 'namespace' => 'User'], function(){
    ...
    Route::get('/cancel/order/list', [AllUserController::class, 'CancelOrderList'])->name('cancel.orders.list');
...
Route::get('/cart-decreament/{rowId}', [CartPageController::class, 'CartDecreament']);
...
// Checkout Page and Frontend District and subdistrict with Ajax
...
// Frontend Blog Option
Route::get('/blog', [UserBlogController::class, 'AddBlogPost'])->name('home.blog');
Route::get('/post/details/{id}', [UserBlogController::class, 'BlogPostDetails'])->name('post.details');
Route::get('/blog/category/post/{category_id}', [UserBlogController::class, 'BlogCategoryWisePost']);
...
// Frontend Advanced Product Search Routes
Route::post('/search-product', [IndexController::class, 'SearchProduct']);


// Frontend Shop Page Routes
Route::get('/shop', [ShopController::class, 'ShopPage'])->name('shop.page');


// Frontend Shop Filter Routes
